...
vim.api.nvim_set_hl(0, "DiagnosticError", { underline = false })
vim.api.nvim_set_hl(0, "DiagnosticWarn", { underline = false })
vim.api.nvim_set_hl(0, "DiagnosticInfo", { underline = false })
vim.api.nvim_set_hl(0, "DiagnosticHint", { underline = false })
